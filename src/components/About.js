    ...
    return(
      ...
      <div style={{display:'flex', justifyContent:'center', alignItems:'center'}}>
        ...
        <div style = {{display:'flex', justifyContent:'space-around', flexFlow:'row wrap', boxSizing:'border-box'}} className='aboutContainer'>
          ...
          <div className='Fernanda' style = {memberBox.mana}>
            <img style = {memberImage} img src={require(`images/most_dogs.png`)} />
            <h3>Fernanda Teixeira</h3>
            <h4>Lead Dev</h4>
            <p>Fernanda has a background and Advertising at Mackenzie University in
          ...
          <div className='mana' style = {memberBox.tomo}>
            <img style = {memberImage} img src={require(`images/most_dogs.png`)} />
            <h3>Mana Koike</h3>
            <h4>Dev and QA</h4>
            <p>Fernanda has a background and Advertising at Mackenzie University in
          ...
          <div className='Fernanda' style = {memberBox.jenn}>
            <img style = {memberImage} img src={require(`images/most_dogs.png`)} />
            <h3>Fernanda Teixeira</h3>
            <h4>Lead Dev</h4>
            <p>Fernanda has a background and Advertising at Mackenzie University in
          ...
          <div className='Fernanda' style = {memberBox.marlowe}>
            <img style = {memberImage} img src={require(`images/most_dogs.png`)} />
            <h3>Fernanda Teixeira</h3>
            <h4>Lead Dev</h4>
            <p>Fernanda has a background and Advertising at Mackenzie University in
